...
class AdminController extends Controller
{
    ...
    public function add_category(Request $request)
    {
        ...
        toastr()->timeOut(10000)->closeButton()->addSuccess('Tạo danh mục thành công');
    ...
    public function delete_category($id)
    {
        ...
        toastr()->timeOut(10000)->closeButton()->addSuccess('Đã xóa danh mục thành công');
    ...
    public function add_brand(Request $request)
    {
        ...
        toastr()->timeOut(10000)->closeButton()->addSuccess('Đã tạo thương hiệu thành công');
    ...
    public function delete_brand($id)
    {
        ...
        toastr()->timeOut(10000)->closeButton()->addSuccess('Đã xóa thương hiệu thành công');
    ...
    public function update_brand(Request $request, $id)
    {
        ...
        toastr()->timeOut(10000)->closeButton()->addSuccess('Đã cập nhật thương hiệu thành công');
    ...
    public function delete_product($id)
    {
        ...
        toastr()->timeOut(10000)->closeButton()->addSuccess('Đã xóa sản phẩm thành công');
    ...
    public function edit_product(Request $request, $id)
    {
        ...
        toastr()->timeOut(10000)->closeButton()->addSuccess('Đã chỉnh sửa sản phẩm thành công');
    ...
    public function delete_user($id)
    {
        ...
        if (!$user) {
            toastr()->timeOut(10000)->closeButton()->addError('Không tìm thấy người dùng');
            return redirect()->back();
        }


        if ($user->id == auth()->id()) {
            toastr()->timeOut(10000)->closeButton()->addError('Bạn không thể xóa tài khoản của chính mình');
            return redirect()->back();
        }

        $user->delete();

        toastr()->timeOut(10000)->closeButton()->addSuccess('Đã xóa người dùng thành công');
    ...
    public function markAsRead($id)
    {
        ...
        return redirect()->back()->with('success', 'Đã đánh dấu tin nhắn là đã đọc');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.view_contacts')->with('success', 'Đã xóa tin nhắn thành công');
    }
    ...
    public function sales_report()
    {
        ...
        $completedOrders = Order::where('status', 'Đã Giao Hàng')
            ->orWhere('payment_status', 'Đã Thanh Toán')
            ->get();
    ...
    public function filter_sales_report(Request $request)
    {
        ...
        // Base query
        $query = Order::where('status', 'Đã Giao Hàng')
            ->orWhere('payment_status', 'Đã Thanh Toán');
