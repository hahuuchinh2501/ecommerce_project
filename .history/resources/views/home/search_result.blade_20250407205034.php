...
<head>
  ...
  <style>
   ...
   .action-buttons {
    display: flex;
    justify-content: space-between; /* Thay đổi ở đây */
    align-items: center; /* Thêm để căn chỉnh theo chiều dọc nếu cần */
}
...
.cart-form {
    display: flex; /* Đảm bảo form cũng là flex container */
    align-items: center; /* Căn chỉnh các phần tử trong form */
}
