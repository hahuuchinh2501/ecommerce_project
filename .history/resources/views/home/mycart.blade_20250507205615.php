...
<body>
    ...
    <div class="container">
        ...
        <div class="div_deg">
            ...
            <form action="{{ url('confirm_order') }}" method="Post">
                ...
                <div>
                    <input class="btn btn-primary" type="submit" value="Thanh Toán tiền mặt">
                            ...
                            <td>
                                <div class="quantity-cell">
                                    <input
                                        ...
                                        data-id="{{ $cartItem->id }}"
                                        data-max="{{ $cartItem->product->quantity }}"
                                        onchange="updateQuantity(this)"
                                    >
                                    <div class="stock-info {{ $cartItem->product->quantity < 5 ? 'stock-warning' : '' }}">
                                        Còn lại: {{ $cartItem->product->quantity }}
                                    </div>
                                </div>
                            </td>
                            <td>
    ...
    <script>
        ...
        // Kiểm tra tất cả các ô số lượng khi trang tải
