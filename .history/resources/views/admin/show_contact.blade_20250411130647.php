  ...
  <body>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Quick Reply</h6>
        </div>
        <div class="card-body">
            <form action="#" method="POST">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="subject" value="RE: Contact Form Submission" required>
                </div>
                <div class="form-group">
                    <textarea class="form-control" name="message" rows="5" required>Dear {{ $contact->name }},
