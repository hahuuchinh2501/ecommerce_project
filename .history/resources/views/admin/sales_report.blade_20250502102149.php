        ...
        <div class="page-content">
            <div class="page-header">
                <div class="container-fluid">
                    <h2 class="h5 no-margin-bottom">Báo Cáo Doanh Thu Bán Hàng</h2>
                </div>
            </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="block">
                                <div class="title">
                                    <h3 class="h4">Lọc Báo Cáo Bán Hàng</h3>
                                </div>
                                <div class="block-body">
                                    <form action="{{ url('filter_sales_report') }}" method="GET" class="form-inline">
                                        ...
                                        <button type="submit" class="btn btn-primary mb-3">Áp Dụng Lọc</button>
                                        <a href="{{ url('sales_report') }}" class="btn btn-secondary mb-3 ml-2">Đặt Lại</a>
                                    </form>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="block margin-bottom-sm">
                                <div class="title d-flex justify-content-between align-items-center">
                                    <h3 class="h4">Tổng Quan Bán Hàng</h3>
                                </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-6">
                                            <div class="card bg-info text-white">
                                                <div class="card-body">
                                                    <h5 class="card-title text-white">Tổng Sản Phẩm Đã Bán</h5>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                @else
                                                    <tr>
                                                        <td colspan="7" class="text-center">Không có dữ liệu bán hàng</td>
                                                    </tr>
                                                @endif
                                            </tbody>
                                        </table>
